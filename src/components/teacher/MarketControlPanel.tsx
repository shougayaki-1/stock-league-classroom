    ...
    <Card component="section">
      <CardContent>
        <Stack spacing={2}>
          ...
          <Typography color="text.secondary">{lease ? '市場の開始・終了やニュース配信を行えます。終了後も必要なら市場を再開できます。' : canResume ? 'ホストを取得すると、市場を再開できます。チームの資産と取引履歴は保持されています。' : '最初にホスト権限を取得してください。ほかの端末が操作中の場合は取得できません。'}</Typography>
          <Divider />
          {!lease
