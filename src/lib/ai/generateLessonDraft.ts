...
export interface GenerateLessonDraftInput { theme: string; mainObjective: string; subject: 'SOCIAL_STUDIES' | 'HOME_ECONOMICS'; difficulty: 'BASIC' | 'STANDARD' | 'ADVANCED'; materialTexts?: string[] }
