...
describe('market identity', () => {
  ...
  it('copies immutable starting cash and configured price phases into live market state', () => {
    const state = initialLiveState({ ownerUid: 'teacher', visibility: 'private', joinCode: 'ABC', teams: [], template: { title: 't', description: '', startingCash: 5000, companies: [{ id: 'acme', name: 'Acme', symbol: 'AC', initialPrice: 100, initialShares: 1, pricePhases: [{ id: 'up', startMinute: 0, endMinute: 60, direction: 'UP', changePercent: 10 }] }] } })
